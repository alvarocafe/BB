function cal_Aeb(b1,b2,arg)
    ...
    for i in b1
	    ...
	    nos = ELEM[j,2:4];		
            ...
            if i==j 
                g,h=calcula_HeGs(x1,y1,z1,x2,y2,z2,x3,y3,z3,xd,yd,zd,qsi,w,k); 
            else 
                g,h=calcula_GeHns(x1,y1,z1,x2,y2,z2,x3,y3,z3,xd,yd,zd,n,qsi_tri,w_tri,k); 
            end            
            if tipoCDC == 0 
        	A[ci,cj] = -g; 	
                if valorCDC == 0
