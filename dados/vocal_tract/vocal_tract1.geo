		...
		// Defining the points
		Point(1) = {-19.545253955927222, 0, 0, 10.0};
		Point(2) = {0, 0, 0,10.0};
		Point(3) = {19.545253955927222,0,0,10.0};
		// Defining the circles
		Circle(1) = {1, 2, 3};
		Circle(2) = {3, 2, 1};
		
			// Defining the points
			Point(4) = {-21.310146732879605, 0, 10, 10.0};
			Point(5) = {0, 0, 10,10.0};
			Point(6) = {21.310146732879605,0,10,10.0};
			// Defining the circles
			Circle(5) = {4, 5, 6};
			Circle(6) = {6, 5, 4};
			...
			// Defining the points
			Point(7) = {-5.170802717077119, 0, 20, 10.0};
			Point(8) = {0, 0, 20,10.0};
			Point(9) = {5.170802717077119,0,20,10.0};
			// Defining the circles
			Circle(9) = {7, 8, 9};
			Circle(10) = {9, 8, 7};
			// Defining the surface
			...
			// Defining the points
			Point(10) = {-9.4076680563148, 0, 30, 10.0};
			Point(11) = {0, 0, 30,10.0};
			Point(12) = {9.4076680563148,0,30,10.0};
			// Defining the circles
			Circle(13) = {10, 11, 12};
			Circle(14) = {12, 11, 10};
			// Defining the surface
			...
			// Defining the points
			Point(13) = {-11.503313482089075, 0, 40, 10.0};
			Point(14) = {0, 0, 40,10.0};
			Point(15) = {11.503313482089075,0,40,10.0};
			// Defining the circles
			Circle(17) = {13, 14, 15};
			Circle(18) = {15, 14, 13};
			// Defining the surface
			...
			// Defining the points
			Point(16) = {-11.50324350636607, 0, 50, 10.0};
			Point(17) = {0, 0, 50,10.0};
			Point(18) = {11.50324350636607,0,50,10.0};
			// Defining the circles
			Circle(21) = {16, 17, 18};
			Circle(22) = {18, 17, 16};
			// Defining the surface
			...
			// Defining the points
			Point(19) = {-5.121011125832254, 0, 60, 10.0};
			Point(20) = {0, 0, 60,10.0};
			Point(21) = {5.121011125832254,0,60,10.0};
			// Defining the circles
			Circle(25) = {19, 20, 21};
			Circle(26) = {21, 20, 19};
			// Defining the surface
			...
			// Defining the points
			Point(22) = {-18.585527919680878, 0, 70, 10.0};
			Point(23) = {0, 0, 70,10.0};
			Point(24) = {18.585527919680878,0,70,10.0};
			// Defining the circles
			Circle(29) = {22, 23, 24};
			Circle(30) = {24, 23, 22};
			// Defining the surface
			...
			// Defining the points
			Point(25) = {-13.503163639952795, 0, 80, 10.0};
			Point(26) = {0, 0, 80,10.0};
			Point(27) = {13.503163639952795,0,80,10.0};
			// Defining the circles
			Circle(33) = {25, 26, 27};
			Circle(34) = {27, 26, 25};
			// Defining the surface
			...
			// Defining the points
			Point(28) = {-11.752515408875547, 0, 90, 10.0};
			Point(29) = {0, 0, 90,10.0};
			Point(30) = {11.752515408875547,0,90,10.0};
			// Defining the circles
			Circle(37) = {28, 29, 30};
			Circle(38) = {30, 29, 28};
			// Defining the surface
			...
			// Defining the points
			Point(31) = {-10.819036924733739, 0, 100, 10.0};
			Point(32) = {0, 0, 100,10.0};
			Point(33) = {10.819036924733739,0,100,10.0};
			// Defining the circles
			Circle(41) = {31, 32, 33};
			Circle(42) = {33, 32, 31};
			// Defining the surface
			...
			// Defining the points
			Point(34) = {-10.457617949918202, 0, 110, 10.0};
			Point(35) = {0, 0, 110,10.0};
			Point(36) = {10.457617949918202,0,110,10.0};
			// Defining the circles
			Circle(45) = {34, 35, 36};
			Circle(46) = {36, 35, 34};
			// Defining the surface
			...
			// Defining the points
			Point(37) = {-21.201473933190652, 0, 120, 10.0};
			Point(38) = {0, 0, 120,10.0};
			Point(39) = {21.201473933190652,0,120,10.0};
			// Defining the circles
			Circle(49) = {37, 38, 39};
			Circle(50) = {39, 38, 37};
			// Defining the surface
			...
			// Defining the points
			Point(40) = {-19.7916287913187, 0, 130, 10.0};
			Point(41) = {0, 0, 130,10.0};
			Point(42) = {19.7916287913187,0,130,10.0};
			// Defining the circles
			Circle(53) = {40, 41, 42};
			Circle(54) = {42, 41, 40};
			// Defining the surface
