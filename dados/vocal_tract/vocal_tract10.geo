		...
		// Defining the points
		Point(1) = {-8.107708483656054, 0, 0, 10.0};
		Point(2) = {0, 0, 0,10.0};
		Point(3) = {8.107708483656054,0,0,10.0};
		// Defining the circles
		Circle(1) = {1, 2, 3};
		Circle(2) = {3, 2, 1};
		
			// Defining the points
			Point(4) = {-6.60620426854552, 0, 10, 10.0};
			Point(5) = {0, 0, 10,10.0};
			Point(6) = {6.60620426854552,0,10,10.0};
			// Defining the circles
			Circle(5) = {4, 5, 6};
			Circle(6) = {6, 5, 4};
			...
			// Defining the points
			Point(7) = {-8.482370071615133, 0, 20, 10.0};
			Point(8) = {0, 0, 20,10.0};
			Point(9) = {8.482370071615133,0,20,10.0};
			// Defining the circles
			Circle(9) = {7, 8, 9};
			Circle(10) = {9, 8, 7};
			// Defining the surface
			...
			// Defining the points
			Point(10) = {-20.92687553653569, 0, 30, 10.0};
			Point(11) = {0, 0, 30,10.0};
			Point(12) = {20.92687553653569,0,30,10.0};
			// Defining the circles
			Circle(13) = {10, 11, 12};
			Circle(14) = {12, 11, 10};
			// Defining the surface
			...
			// Defining the points
			Point(13) = {-3.5493218587939084, 0, 40, 10.0};
			Point(14) = {0, 0, 40,10.0};
			Point(15) = {3.5493218587939084,0,40,10.0};
			// Defining the circles
			Circle(17) = {13, 14, 15};
			Circle(18) = {15, 14, 13};
			// Defining the surface
			...
			// Defining the points
			Point(16) = {-21.517933788076995, 0, 50, 10.0};
			Point(17) = {0, 0, 50,10.0};
			Point(18) = {21.517933788076995,0,50,10.0};
			// Defining the circles
			Circle(21) = {16, 17, 18};
			Circle(22) = {18, 17, 16};
			// Defining the surface
			...
			// Defining the points
			Point(19) = {-11.162221203649374, 0, 60, 10.0};
			Point(20) = {0, 0, 60,10.0};
			Point(21) = {11.162221203649374,0,60,10.0};
			// Defining the circles
			Circle(25) = {19, 20, 21};
			Circle(26) = {21, 20, 19};
			// Defining the surface
			...
			// Defining the points
			Point(22) = {-21.252737486432267, 0, 70, 10.0};
			Point(23) = {0, 0, 70,10.0};
			Point(24) = {21.252737486432267,0,70,10.0};
			// Defining the circles
			Circle(29) = {22, 23, 24};
			Circle(30) = {24, 23, 22};
			// Defining the surface
			...
			// Defining the points
			Point(25) = {-14.746718582524197, 0, 80, 10.0};
			Point(26) = {0, 0, 80,10.0};
			Point(27) = {14.746718582524197,0,80,10.0};
			// Defining the circles
			Circle(33) = {25, 26, 27};
			Circle(34) = {27, 26, 25};
			// Defining the surface
			...
			// Defining the points
			Point(28) = {-16.99171305066969, 0, 90, 10.0};
			Point(29) = {0, 0, 90,10.0};
			Point(30) = {16.99171305066969,0,90,10.0};
			// Defining the circles
			Circle(37) = {28, 29, 30};
			Circle(38) = {30, 29, 28};
			// Defining the surface
			...
			// Defining the points
			Point(31) = {-9.634165795459122, 0, 100, 10.0};
			Point(32) = {0, 0, 100,10.0};
			Point(33) = {9.634165795459122,0,100,10.0};
			// Defining the circles
			Circle(41) = {31, 32, 33};
			Circle(42) = {33, 32, 31};
			// Defining the surface
			...
			// Defining the points
			Point(34) = {-7.920060042921516, 0, 110, 10.0};
			Point(35) = {0, 0, 110,10.0};
			Point(36) = {7.920060042921516,0,110,10.0};
			// Defining the circles
			Circle(45) = {34, 35, 36};
			Circle(46) = {36, 35, 34};
			// Defining the surface
			...
			// Defining the points
			Point(37) = {-19.361979579093894, 0, 120, 10.0};
			Point(38) = {0, 0, 120,10.0};
			Point(39) = {19.361979579093894,0,120,10.0};
			// Defining the circles
			Circle(49) = {37, 38, 39};
			Circle(50) = {39, 38, 37};
			// Defining the surface
			...
			// Defining the points
			Point(40) = {-19.32087784493047, 0, 130, 10.0};
			Point(41) = {0, 0, 130,10.0};
			Point(42) = {19.32087784493047,0,130,10.0};
			// Defining the circles
			Circle(53) = {40, 41, 42};
			Circle(54) = {42, 41, 40};
			// Defining the surface
